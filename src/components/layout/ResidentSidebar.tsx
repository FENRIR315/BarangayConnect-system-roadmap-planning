...
const navItems = [
  ...
  { label: "Complaints", href: "/resident/complaints", icon: AlertTriangle },
  ...
  const sidebarContent = (
    <>
      <div className="flex h-16 items-center gap-2 border-b border-gray-200 px-6">
        ...
        <span className="text-lg font-bold text-gray-900">Resident Portal</span>
      ...
      <div className="border-t border-gray-200 p-4">
        <div className="mb-3 flex items-center gap-3 rounded-lg bg-gray-50 p-3">
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-gray-500">Resident</p>
          </div>
        </div>
    ...
    <>
      ...
      <div className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 lg:hidden">
        <Link href="/resident/dashboard" className="flex items-center gap-2">
          ...
          <span className="font-bold text-gray-900">Resident Portal</span>
        </Link>
